...
parser.add_argument(
    ...
    default='switch-db2.erg.berkeley.edu', metavar='hostname', # Paty: figure out/edit later switch-db2.erg.berkeley.edu
...
#              'FROM chile_new.timescales_sample_timeseries sts '
#              'JOIN chile_new.timescales_population_timeseries pts ON sts.sampled_from_population_timeseries_id=pts.population_ts_id '
#              'JOIN chile_new.timescales_periods p USING (period_id) '
